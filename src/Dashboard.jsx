...
export default function Dashboard() {
  ...
  // GPU-accelerated glassmorphism style string
  ...
  return (
    <div className="relative min-h-screen bg-surface text-on-surface overflow-x-hidden selection:bg-primary-container selection:text-on-primary-container">
      ...
      {/* Main Content */}
      <main className="relative z-10 w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg">
        {/* Extreme Glass Location Banner */}
        {showBanner && !locationAllowed && (
          <div
            id="location-banner"
            className={`rounded-2xl p-4 md:p-6 mb-stack-lg flex flex-col md:flex-row items-center justify-between gap-4 relative overflow-hidden ${ultraGlassStyle}`}
          >
            ...
            <div className="relative z-10 flex items-start md:items-center gap-4">
              ...
              <div>
                <h2 className="font-title-md text-title-md text-on-surface mb-1 font-bold">
        ...
        {/* 2-2-2-1 Grid Layout (7 Cards) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card 1: Workspaces */}
          <div
            onClick={() => handleCategoryClick('workspaces')}
            className={`rounded-[28px] p-6 h-[320px] flex flex-col justify-end relative overflow-hidden group ${ultraGlassStyle}`}
          >
            <div className="absolute inset-0 z-0">
              <div
                className="bg-cover bg-center w-full h-full opacity-50 group-hover:opacity-85 group-hover:scale-105 transition-[transform,opacity] duration-500 transform-gpu"
                style={{
                  backgroundImage:
            ...
            <div className="relative z-10 transform group-hover:-translate-y-2 transition-transform duration-300 transform-gpu">
              ...
              <h3 className="font-headline-lg text-[28px] font-bold text-white mb-1 drop-shadow-md">
                Workspaces
              </h3>
              <p className="font-body-md text-white/80 text-sm drop-shadow-sm">
                Remote &amp; Public Hubs
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10 transform group-hover:-translate-y-2 transition-transform duration-300 transform-gpu">
              <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center mb-4 text-yellow-300 border border-white/25 shadow-inner">
                <span
                  className="material-symbols-outlined text-2xl"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
          ...
          {/* Card 6: Airbnbs */}
          <div
            onClick={() => handleCategoryClick('airbnbs')}
            className={`rounded-[28px] p-6 h-[320px] flex flex-col justify-end relative overflow-hidden group ${ultraGlassStyle}`}
          >
            <div className="absolute inset-0 z-0">
              <div
          ...
          {/* Card 7: Hidden Gem Spots */}
          <div
            onClick={() => handleCategoryClick('hidden_gems')}
            className={`rounded-[28px] p-6 h-[320px] flex flex-col justify-end relative overflow-hidden group md:col-span-2 md:w-1/2 md:mx-auto w-full ${ultraGlassStyle}`}
          >
            <div className="absolute inset-0 z-0">
              <div
                className="bg-cover bg-center w-full h-full opacity-50 group-hover:opacity-85 group-hover:scale-105 transition-[transform,opacity] duration-500 transform-gpu"
            ...
            <div className="relative z-10 transform group-hover:-translate-y-2 transition-transform duration-300 transform-gpu">
              <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center mb-4 text-emerald-300 border border-white/25 shadow-inner">
                <span
                  className="material-symbols-outlined text-2xl"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
              ...
              <p className="font-body-md text-white/80 text-sm drop-shadow-sm">
                Secret Spots &amp; Offbeat Locations
              </p>
            </div>
          </div>
        </div>
